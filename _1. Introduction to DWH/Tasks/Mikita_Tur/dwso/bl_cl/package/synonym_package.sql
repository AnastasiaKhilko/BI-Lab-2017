CREATE PACKAGE pckg_synonyms  
  AUTHID CURRENT_USER as
  PROCEDURE Create_Syn_Priv (Schema_Name IN varchar2, Object_Name IN varchar2, Synonym_Name IN varchar2);
  Procedure Create_Syn_Pub  (Schema_Name IN varchar2, Object_Name IN varchar2, Synonym_Name IN varchar2);
END pckg_synonyms;


CREATE PACKAGE BODY  pckg_synonyms AS 
