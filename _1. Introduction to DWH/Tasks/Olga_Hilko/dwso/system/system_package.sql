...
AUTHID CURRENT_USER
AS
  PROCEDURE GRANT_BLAT (GRANT_NAME IN VARCHAR2, SCHEMA_NAME IN VARCHAR2, OBJECT_NAME IN VARCHAR2, USER_NAME IN VARCHAR2);
  PROCEDURE GRANT_BLAT (GRANT_NAME IN VARCHAR2, USER_NAME IN VARCHAR2, WAO IN BOOLEAN := FALSE);
END grants_mgmt;
/
