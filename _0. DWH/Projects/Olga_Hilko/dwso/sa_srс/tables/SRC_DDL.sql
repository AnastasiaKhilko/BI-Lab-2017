...
CREATE OR REPLACE DIRECTORY ext_tables AS
  '/media/sf_DWH/SRC/';
     ...
     exec  FRAMEWORK.pkg_utl_drop.proc_drop_obj ('ext_geo_countries_iso3166', 'TABLE');
    ...
    reject LIMIT unlimited;
      ...
      exec  FRAMEWORK.pkg_utl_drop.proc_drop_obj ('ext_geo_structure_iso3166', 'TABLE');
   create table ext_geo_structure_iso3166  
    ...
    reject limit unlimited;
      ...
      exec  FRAMEWORK.pkg_utl_drop.proc_drop_obj ('ext_cntr2structure_iso3166', 'TABLE');
