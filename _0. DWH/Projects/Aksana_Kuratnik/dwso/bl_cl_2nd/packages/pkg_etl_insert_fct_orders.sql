...
BEGIN
   INSERT INTO  
             bl_dm.fct_orders
   SELECT    
             bl_dm.fact_orders_seq.NEXTVAL AS sale_id,
             a.order_id,
             a.order_dt,
             c.seller_surr_id,
             b.customer_surr_id,
      ...
      FROM   cls_fct_orders a INNER JOIN bl_dm.dim_customers b ON a.customer_surr_id = b.customer_id
                                       INNER JOIN bl_dm.dim_sellers c ON a.seller_surr_id = c.seller_id
                                       INNER JOIN bl_dm.dim_payment_methods d ON a.payment_method_surr_id = d.payment_method_id
                                       INNER JOIN bl_dm.dim_delivery_methods e ON a.delivery_method_surr_id = e.delivery_method_id
